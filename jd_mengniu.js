...
————————————————
入口：[组队分豆-蒙牛 (https://lzkjdz-isv.isvjcloud.com/pool/captain/4471266?activityId=4e3b9b6233104c199c0c44ff6edbc85d&signUuid=fce374306b4046c28fdf73667a51e2de)]
IOS等用户直接用NobyDa的jd cookie
============Quantumultx===============
[task_local]
#组队分豆-蒙牛
18 1,16 * * * https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_mengniu.js, tag=组队分豆-蒙牛, enabled=true
================Loon==============
[Script]
cron "18 1,16 * * *" script-path=https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_mengniu.js,tag=组队分豆-蒙牛
===============Surge=================
组队分豆-蒙牛 = type=cron,cronexp="18 1,16 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_mengniu.js
============小火箭=========
组队分豆-蒙牛 = type=cron,script-path=https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_mengniu.js, cronexpr="18 1,16 * * *", timeout=3600, enable=true
*/
...
!(async () => {
    ...
    console.log(`若之前做过该活动，则无法重复入队。\n入口:\nhttps://lzkjdz-isv.isvjcloud.com/pool/captain/4471266?activityId=4e3b9b6233104c199c0c44ff6edbc85d&signUuid=fce374306b4046c28fdf73667a51e2de`)
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['fce374306b4046c28fdf73667a51e2de']
            $.bean = 0;
