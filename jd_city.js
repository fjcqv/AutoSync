...
// 优先助力[助力码]
let helpShareFlag = "true";//是否优先助力[助力码]，默认是
...
let inviteCodes = ['-ryUXKxaZDYWZxTDTtiTpBPcQaFkKnFh','oeD5WqsMb2VBZxKrCpeJ902SCec1','4LS-HfMSY2ZCa32ZBpfFuyAeAXg']
$.shareCodesArr = [];
...
!(async () => {
  ...
  if(helpShareFlag+"" == "true"){
    ...
    console.log('脚本优先助力[内部账号] 如需开启优先助力[助力码]，请设置环境变量  JD_CITY_HELPSHARE 为true\n')
  }
