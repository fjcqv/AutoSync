/*
会场红包
cron 0 0,20,23,12 * * * https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_nhs_red.js
* */
const $ = new Env('会场红包');
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
let flCode =  $.isNode() ? (process.env.FLCODE3 ? process.env.FLCODE3 : 'SLuybOI'):'SLuybOI';
let cookiesArr = [];
if ($.isNode()) {
